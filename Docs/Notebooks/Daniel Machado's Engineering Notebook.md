...
Today we decided that I will be stopping testing for a bit. I need to refractor the code I was working on because there are some methods that are way too big, which makes it really hard to test. Luckily its just a couple of methods. I spoke with Leah to see if she will be able to take on the testing of the other parts of the code while I refractor the network generation code. Hopefully it wont take too long - I am aiming rto have it done by monday since it is not really that bad

### Entry 2/22
Today I worked on refractoring the code. It is a lot easier than I thought it was gonna be. Just grabbed code that repeated a lot and threw it into many functions.

### Entry 2/25
Just checked up with the team online. Decided to cancel the meeting and meet thursday. Some of us were studying for an Ochoa test, so we were mostly focused on that. We talked to John and agreed to meet on thursday (next meeting).

### Entry 2/27
Today I kept on refractoring code, but still not done. I am currently working on the code I made last semester. We were supposed to meet with john but he canceled last minute. Asked Leah for help with the testing, but I think she'll join me later.

### Entry 3/4
Couldnt make it to class. But had to work on SDD and tried to finish up some of the refractoring. Honestly not much done today. John also canceled again.

### Entry 3/6
SImply worked on the SDS. Added some diagrams I had made, and touched up on a couple of old ones.  Ive been busy with documentation, but refractoring is done and im working on testing again. A bit frustrated because I keep doing test cases, and then learn how to actually make them in Ochoa's class, so I see how bad mines were and keep on rewriting them. Also John is not able to meet in person anymore.


### Entry 3/18
Had to stay in Miami for the week, so I have been trying to work on test cases. I am currently working on white box testing, as I already finished some of the black box. There wasnt much of black box, so I think white box will be more extensive. Currently learning about it on QA so might be a bit slow.

### Entry 3/25
I got to Daytona today. I am really behind work and need to finish white box testing ASAP. We are still missing Simon's part to test plus everything on mine I havent tested. I think Simon's part will be harder to do, so I need to finish this section fast.

### Entry 3/27
Still working on testing. Lacking a bit but almost done with my part. Need a last few touches. I will be working with Leah on the System test Plan.


### Entry 4/1
Could not make it to class, but testing for my part is 99% done. Just need to finish testing the higher level components. Smaller functions are all tested and working as expected.

### Entry 4/8
Finished testing. Finally. I asked Leah to keep working on the System Test Plan based on the test cases I have made on the code. All she needs to do, is run them and document whether they pass or not. Now I need to do Simon's code, which will probably take a while to finish.

### Entry 4/10
Started testing Simons code. Extremely hard. Very few functions, with complex parameters that are hard to mock. 

###  Entry 4/14
We were supposed to meet with John today, but I left for a trip to Arizona. I will be out the whole week so probably not much will be done. I did attempt to test Simon's code again, but it is taking so much longer than I thought. The complexity of the code is no joke.

### Entry 4/22
Met with Akbas, we have all pretty much finished everything. I was barely able to test SImon's part because of my lack of time + complexity / coupling of his code. Big and complex functions were not easy to work with. The guys got me up to date with what they talked to john. John seems pretty happy with the project, as all of the major features were met (MVP). Happy with this team, but annoyed I could not do more of the testing. 